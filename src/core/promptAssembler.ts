 ...
 */
export function buildPatternExamplesSection(
  enabledConstraints: ConstraintDocument[],
): string {
 ...
 */
export function buildArchitectureChecklist(
  enabledConstraints: ConstraintDocument[],
): string {
 ...
 */
export function buildImplementationOrderSection(): string {
  const lines: string[] = [];
  lines.push("");
...
export function assemblePrompt(
  ...
  if (!legacyFormat) {
    ...
    const patternExamplesSection =
      buildPatternExamplesSection(enabledConstraints);
    if (patternExamplesSection) {
      lines.push(patternExamplesSection);
    }

    const architectureChecklist = buildArchitectureChecklist(
      enabledConstraints,
    );
