...
export function buildSingleInstructionPackage(options) {
...
function toInstructionBlock(doc) {
...
function extractDetectionSteps(section) {
...
function extractReportFields(section, constraintId) {
    const lines = section.split(/\r?\n/);
    for (const rawLine of lines) {
        const line = rawLine.trim();
        if (!line)
